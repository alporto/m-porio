...
<head>
  ...
  <meta name="description" content="Hybrid Studio Lab Admin - Pagina index">
  <meta name="author" content="www.krakenstudio.it">

  <title>emporio Admin - Dashboard</title>
       ...
       <!--  <div class="card mb-3">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Prenotazioni di oggi</div>
          <div class="card-body">
            <div class="table-responsive dektop">
